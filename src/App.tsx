  ...
  return (
    <section id="home" className="relative min-h-screen w-full flex items-center justify-center overflow-hidden pt-32 md:pt-40 pb-12 md:pb-16">
      ...
      <div className="z-20 w-full max-w-7xl mx-auto px-6 grid md:grid-cols-12 items-center min-h-screen md:min-h-[80vh] relative">
        ...
        <div className="hidden md:block md:absolute md:bottom-0 md:right-0 w-full md:w-[45%] h-[82vh] pointer-events-none select-none z-10 flex items-end justify-end">
          <img 
            src="/profile.png" 
            alt="J. Roberto Brandt" 
            className="w-full h-full object-contain object-bottom grayscale opacity-80"
          />
        </div>
      </div>
    </section>
